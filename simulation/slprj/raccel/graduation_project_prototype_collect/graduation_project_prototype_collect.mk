...
MODULES                 = rt_matrx.c rt_printf.c graduation_project_prototype_collect.c graduation_project_prototype_collect_capi.c graduation_project_prototype_collect_data.c graduation_project_prototype_collect_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_spid_contc.c
PRODUCT                 = graduation_project_prototype_collect.exe
