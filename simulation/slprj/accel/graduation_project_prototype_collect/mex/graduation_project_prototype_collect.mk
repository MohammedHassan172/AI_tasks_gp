...
MODEL                   = graduation_project_prototype_collect
MODULES                 = graduation_project_prototype_collect_acc.c graduation_project_prototype_collect_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\graduation_project_prototype_collect_acc.mexw64
MAKEFILE                = graduation_project_prototype_collect.mk
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:graduation_project_prototype_collect_acc.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = graduation_project_prototype_collect_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = graduation_project_prototype_collect_ref.rsp
COMPILER_COMMAND_FILE     = graduation_project_prototype_collect_comp.rsp
...
graduation_project_prototype_collect_acc.obj : $(START_DIR)\slprj\accel\graduation_project_prototype_collect\graduation_project_prototype_collect_acc.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\graduation_project_prototype_collect\graduation_project_prototype_collect_acc.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\graduation_project_prototype_collect\graduation_project_prototype_collect_acc.c

graduation_project_prototype_collect_acc_data.obj : $(START_DIR)\slprj\accel\graduation_project_prototype_collect\graduation_project_prototype_collect_acc_data.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\graduation_project_prototype_collect\graduation_project_prototype_collect_acc_data.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\graduation_project_prototype_collect\graduation_project_prototype_collect_acc_data.c

rtGetInf.obj : $(START_DIR)\slprj\accel\graduation_project_prototype_collect\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\graduation_project_prototype_collect\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\graduation_project_prototype_collect\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\slprj\accel\graduation_project_prototype_collect\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\graduation_project_prototype_collect\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\graduation_project_prototype_collect\rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)\slprj\accel\graduation_project_prototype_collect\rt_nonfinite.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\graduation_project_prototype_collect\rt_nonfinite.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\graduation_project_prototype_collect\rt_nonfinite.c
