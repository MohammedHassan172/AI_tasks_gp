...
MODEL                   = graduation_project_prototype_collect_4
MODULES                 = graduation_project_prototype_collect_4_acc.c graduation_project_prototype_collect_4_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\graduation_project_prototype_collect_4_acc.mexw64
MAKEFILE                = graduation_project_prototype_collect_4.mk
MATLAB_ROOT             = D:\power 2 soft\R2023a
ALT_MATLAB_ROOT         = D:\power 2 soft\R2023a
START_DIR               = D:\graduation_project\version_control\Sensorless_Speed_Control_IM\simulation
S_FUNCTIONS_LIB         = 
NUMST                   = 7
NCSTATES                = 18
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:graduation_project_prototype_collect_4_acc.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = graduation_project_prototype_collect_4_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = graduation_project_prototype_collect_4_ref.rsp
COMPILER_COMMAND_FILE     = graduation_project_prototype_collect_4_comp.rsp
...
graduation_project_prototype_collect_4_acc.obj : $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\graduation_project_prototype_collect_4_acc.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\graduation_project_prototype_collect_4_acc.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\graduation_project_prototype_collect_4_acc.c

graduation_project_prototype_collect_4_acc_data.obj : $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\graduation_project_prototype_collect_4_acc_data.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\graduation_project_prototype_collect_4_acc_data.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\graduation_project_prototype_collect_4_acc_data.c

rtGetInf.obj : $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\rt_nonfinite.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\rt_nonfinite.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\graduation_project_prototype_collect_4\rt_nonfinite.c
