...
joblib.dump(input_scaler, 'input_scaler_beta&alhpa_PerUnit.pkl')
...
try:
    ...
    rated_I_beta = float(input("Enter the rated I_beta value: "))
    rated_I_alpha = float(input("Enter the rated I_alpha value: "))
    ...
    while True:
        ...
        new_input_per_unit = new_input / np.array([[rated_I_beta, rated_I_alpha]])
